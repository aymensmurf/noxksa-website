...
const OurService = ({ isRTL, t }) => {
	return (
		<>
			<a name='our-services' />
			<section>
				{isRTL ? <BannerRight title={t("OURSERVICES.SERVICES")} /> : <BannerLeft title={t("OURSERVICES.SERVICES")} />}
						...
						<>
							{isRTL ? (
								<div>
									<span>برامجنا</span>
									<br />
									<span style={{ color: "#F7006C" }}>الترفيهية</span>
								</div>
							) : (
								<div>
									<span>Our</span>
									<br />
									<span style={{ color: "#F7006C" }}>Entertainment</span>
									<br />
									<span style={{ color: "#FFC581" }}>Programs</span>
									<br />
								</div>
							)}
						</>
						...
						<>
							{isRTL ? (
								...
								<div>
									...
									<span style={{ color: "#F7006C" }}>Entertainment</span>
									<br />
									<span style={{ color: "#FFC581" }}>Services</span>
									<br />
								</div>
							)}
						</>
				...
				<ImageRight
					text={
						<>
							{isRTL ? (
								<div>
									<span style={{ color: "#F7006C" }}>فعالياتنا</span>
									<br />
									<span style={{ color: "#FFC581" }}>الترفيهية</span>
									<br />
								</div>
							) : (
								<div>
									...
									<span style={{ color: "#F7006C" }}>Entertainment</span>
									<br />
									<span style={{ color: "#FFC581" }}>Activities</span>
									<br />
								</div>
							)}
						</>
