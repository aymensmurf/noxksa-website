...
const ContactUs = ({ isRTL, t }) => {
	return (
		<>
			<a name='contact-us' />
			<section>
				{isRTL ? <BannerLeft title={t("CONTACTUS.contactus")} /> : <BannerRight title={t("CONTACTUS.contactus")} />}
						...
						<div className='flex jc-sb flex-wrap' style={{ marginTop: 0, gap: 60 }}>
							<div>
								...
								<div className='flex ai-c'>
									...
									<p style={{ direction: "ltr" }}>+966 55 444 3450</p>
								</div>
								<div className='flex ai-c'>
							...
							<div>
								...
								<div className='flex ai-c'>
									<a href='https://twitter.com/NoxKsa' target='_blank' rel='noopener noreferrer'>
										<Icon src='/img/icons/tw.png' alt='Twitter' />
									</a>
									<a href='https://www.facebook.com/nox.ksa' target='_blank' rel='noopener noreferrer'>
										<Icon src='/img/icons/fb.png' alt='Phone' />
									</a>
									<a href='https://www.instagram.com/nox.ksa' target='_blank' rel='noopener noreferrer'>
										<Icon src='/img/icons/in.png' alt='Phone' />
									</a>
								</div>
							</div>
						</div>
